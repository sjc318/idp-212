...
def turnDecision(branchProfile, sensors, motors, path, pathIndex, tofs):
    global end
                ...
                if(robotStatus == "followCircuit"):
                    if(end == False):
                        ...
                        if(decisionSkipTime == 0):
                            circuitPathIndex = turnDecision(branchProfile, sensors, motors, circuitPath, circuitPathIndex, tofs)
                    ...
                    #print(branchProfile)
                    if(decisionSkipTime == 0):
                        bayPathIndex = turnDecision(branchProfile, sensors, motors, bayPath, bayPathIndex, tofs)
